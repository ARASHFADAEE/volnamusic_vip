...
<main class="main">
    <div class="container-fluid">
        ...
        <section class="row row--grid">
            ...
            <div class="col-12">
                <div class="main__title">
                    <h2>جدید ترین آلبوم های منتشر شده</h2>
                ...
                <div class="main__carousel-wrap">
                    <div class="main__carousel main__carousel--artists owl-carousel" id="artists">
                        ...
                        foreach($categories as $category) {
                            ...
                            echo "<a href='" . get_category_link($category->term_id) . "' class='artist'>
        <div class='artist__cover'>
            <img class='img-artist-cover-category' src='" .  z_taxonomy_image_url($category->term_id) . "'>
        </div>
        <h3 class='artist__title'> $category->name </h3>
    </a>";
        ...
        <section class="row row--grid">
            ...
            if ($query->have_posts()) {
                while ($query->have_posts()) : $query->the_post(); ?>
                    <?php if (get_field('is_single') || get_field('is_album') ) { ?>
